...
describe('mappers', () => {
  ...
  test('map gemini v3 replay depth snapshots from matching update range', () => {
    const geminiMapper = createMapper('gemini', new Date('2026-07-07T22:00:00.000Z'))
      ...
      geminiMapper.map(
        {
          ...
          b: [
            ['0.07029600', '0.200000'],
            ['0.07020900', '0.200000'],
            ['0.07001600', '6295.500000'],
            ['0.06969600', '0.200000'],
            ['0.06945400', '0.200000'],
            ['0.06944500', '11436.100000'],
            ['0.06921200', '0.200000'],
            ['0.06897000', '0.200000'],
            ['0.06872800', '0.200000'],
            ['0.06848600', '0.200000'],
            ['0.06838100', '18303.300000'],
            ['0.06824400', '0.200000'],
            ['0.06800200', '0.200000'],
            ['0.06584200', '9122.600000']
          ],
          a: [
            ['0.07086500', '6296.700000'],
            ['0.07107900', '0.200000'],
            ['0.07139000', '0.200000'],
            ['0.07156100', '11432.000000'],
            ['0.07163200', '0.200000'],
            ['0.07187400', '0.200000'],
            ['0.07211600', '0.200000'],
            ['0.07235800', '0.200000'],
            ['0.07260000', '0.200000'],
            ['0.07262100', '18293.900000'],
            ['0.07284200', '0.200000'],
            ['0.07308400', '0.200000'],
            ['0.07332600', '0.200000'],
            ['0.07498200', '9147.800000'],
            ['0.11750000', '42.553192'],
            ['0.11950000', '41.841005'],
            ['0.15000000', '33.333334'],
            ['0.16000000', '31.250000'],
            ['0.16500000', '30.303031'],
            ['9.72000000', '3078.388419']
          ]
        },
        localTimestamp
      )[0].isSnapshot
